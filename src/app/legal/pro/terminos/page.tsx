          ...
          <div className="mx-auto w-full max-w-6xl px-4">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-2 text-sm md:text-base text-muted-foreground max-w-2xl mx-auto">
                Reglas claras para usar la plataforma como profesional. Leé todo con atención; el
                uso implica aceptación.
              </p>
            </div>
          </div>
        </div>
            ...
            <aside className="hidden lg:block lg:col-span-3">
              <div className="surface rounded-2xl p-4 sticky top-24">
                ...
                <ul className="mt-3 space-y-2 text-sm">
                  <li>
                    <a className="link-primary hover:underline" href="#objeto">
                      1. Objeto del servicio
                    </a>
                  </li>
                  <li>
                    <a className="link-primary hover:underline" href="#requisitos">
                      2. Requisitos del profesional
                    </a>
                  </li>
                  <li>
                    <a className="link-primary hover:underline" href="#pagos">
                      3. Funcionamiento y pagos
                    </a>
                  </li>
                  <li>
            ...
            >
              ...
              <div className="glass border rounded-2xl p-4 md:p-5 flex items-start gap-3 not-prose">
                ...
                <p className="text-sm text-muted-foreground">
                  Bienvenido/a a <strong>DocYa Pro</strong>. Al registrarte y utilizar la
                  plataforma, aceptás estos términos y condiciones.
                </p>
              </div>

              <h2 id="objeto" className="scroll-mt-24">
                1. Objeto del servicio
              </h2>
              <p>
                ...
                vinculación, logística de asignación y procesamiento de pagos, pero{" "}
                <strong>no prestamos servicios médicos</strong> ni sustituimos la relación
                profesional–paciente.
              </p>

              <h2 id="requisitos" className="scroll-mt-24">
                2. Requisitos del profesional
              </h2>
              <ul>
              ...
              <h2 id="pagos" className="scroll-mt-24">
                3. Funcionamiento y pagos
              </h2>
              <ul>
                <li>
              ...
              <p>
                ...
                conflicto, será competente la justicia ordinaria de la Ciudad Autónoma de Buenos
                Aires.
              </p>
