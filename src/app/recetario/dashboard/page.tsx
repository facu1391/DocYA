...
import { getMedico, getToken, saveSession, handleSessionExpired, type MedicoSession } from "@/lib/recetario/auth";
import { listarRecetas, listarPacientes, obtenerPerfilMedico } from "@/lib/recetario/api";
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="animate-fade-up flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Link href="/recetario/dashboard/nueva-receta" className="btn-primary" style={{ textDecoration: "none", alignSelf: "flex-start", display: "flex", alignItems: "center", gap: "0.5rem" }}>
