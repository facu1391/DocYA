...
export function usePedirTheme() {
  ...
  return {
    ...
    surface: dark
      ? "linear-gradient(135deg, rgba(0,179,166,0.08) 0%, rgba(4,21,28,0.97) 60%)"
      : "linear-gradient(135deg, rgba(0,179,166,0.06) 0%, rgba(255,255,255,0.96) 60%)",
    headerBg: dark ? "rgba(4,21,28,0.95)" : "rgba(245,247,250,0.95)",
    videoChromeBg: dark ? "rgba(4,21,28,0.95)" : "rgba(245,247,250,0.95)",
    videoBarBg: dark ? "rgba(4,21,28,0.97)" : "rgba(255,255,255,0.97)",
    overlayBg: dark ? "rgba(4,21,28,0.9)" : "rgba(245,247,250,0.92)",
