      ...
      <div className="container py-12 md:py-16">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-2 text-sm md:text-base text-muted-foreground">
            La calculadora muestra estimaciones con valores de referencia. Podés adaptar precios, comisión
            y costos para ver distintos escenarios.
          </p>
        </div>
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-3 max-w-6xl mx-auto">
          ...
          <article className="surface rounded-2xl p-6 border">
            ...
            <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
              <li className="flex gap-2"><Check className="h-4 w-4 text-[var(--brand)]" />Precio bruto por consulta</li>
              <li className="flex gap-2"><Check className="h-4 w-4 text-[var(--brand)]" />Comisión DocYa</li>
              <li className="flex gap-2"><Check className="h-4 w-4 text-[var(--brand)]" />Costos variables y fijos</li>
              <li className="flex gap-2"><Check className="h-4 w-4 text-[var(--brand)]" />Retenciones estimadas</li>
            </ul>
          </article>
