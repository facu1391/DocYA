...
export default function EarningsCalculator() {
  // Valores base
  const [precio, setPrecio] = useState(30000);     // $ por consulta (bruto)
  const [comision, setComision] = useState(20);    // % DocYa
  const [consultas, setConsultas] = useState(12);  // por semana
  const [costoVar, setCostoVar] = useState(0);     // costo variable por consulta (insumos/traslado)
  const [costoFijo, setCostoFijo] = useState(0);   // costo fijo semanal (ej. abono/seguro)
  const [retencion, setRetencion] = useState(0);   // % retenciones/impuestos aprox. (sobre neto semanal)
  ...
  return (
    <section className="relative">
      ...
      <div className="container relative py-16 md:py-20">
        ...
        {/* Contenido */}
        <div className="grid lg:grid-cols-12 gap-6 mt-10 md:mt-12">
          {/* Panel de entrada */}
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-4">
                ...
                <div>
                  ...
                  <div className="mt-2">
                    ...
                    />
                    {/* Slider nativo (sin depender de otros comp.) */}
                    <input
                      type="range"
                      min={0}
                      max={40}
