  ...
  return (
    <section className="relative py-16 md:py-20 bg-[var(--hero-bg)] dark:bg-[var(--hero-bg-dark)]">
      ...
      <div className="container relative">
        <h2 className="text-center text-2xl md:text-3xl font-semibold">¿Cómo funciona?</h2>

        <ol className="mt-8 grid gap-6 md:grid-cols-3 max-w-5xl mx-auto">
          {steps.map((s, i) => (
            <li
              key={s.title}
              className="
                surface rounded-2xl p-6 md:p-7 border
                shadow-[0_8px_28px_rgba(0,0,0,0.14)] hover:-translate-y-1 transition-all
              "
            >
