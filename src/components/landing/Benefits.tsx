...
const benefits: Benefit[] = [
  {
    ...
    desc:
      "Recibí un pago por cada consulta realizada, con acreditaciones rápidas y transparentes todas las semanas.",
    icon: <Wallet className="h-6 w-6" />,
  },
  {
    title: "Flexibilidad total",
    desc:
      "Vos decidís cuándo y dónde estar disponible. No más horarios fijos ni trámites complicados.",
    icon: <CalendarClock className="h-6 w-6" />,
  },
  {
    title: "Reputación profesional",
    desc:
      "Los pacientes califican tu atención. Mientras más estrellas tengas, más consultas recibís.",
    icon: <Star className="h-6 w-6" />,
  },
  {
    title: "Herramientas digitales",
    desc:
      "Emití recetas, certificados médicos y registrá historias clínicas directamente desde la app.",
      ...
      <div className="container relative">
        ...
        <div
          className="
            mt-10 px-4
            grid gap-6 md:gap-8
            /* 1 col en mobile centrada */
            max-w-[36rem] mx-auto
            /* en md+ pasamos a 2 columnas de ancho fijo y centramos el grid */
            md:max-w-none
            md:[grid-template-columns:repeat(2,minmax(0,36rem))]
            md:justify-center
          "
        >
          {benefits.map((b, i) => (
            <article
              ...
              className="
                ...
                animate-[fade-up_.6s_ease-out_forwards]
              "
