...
function GooglePlayIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 512 512" aria-hidden>
      <path
        fill="#32bbff"
        d="M325.5 238.9 92.4 6.3C86.9.9 79.1-1.3 71.7.7 64.2 2.7 58.5 8.3 56.5 15.8 56 18 55.7 20.3 55.7 22.6V489.4c0 8.3 4.7 15.9 12.1 19.5 7.4 3.6 16.3 2.8 23-2l234.7-179.4 74.8-56.6-74.8-31.9z"
      />
      <path
        fill="#00c1a5"
        d="M436.3 200.6 362 168.6 325.5 238.9l74.8 31.9 36.6-70.2c3.7-7.2 3.3-15.9-.6-23z"
      />
      <path
        fill="#ffdf00"
        d="m362 168.6-53.8-22.9-215.8-91.8c-4.1-1.7-8.6-2-12.9-.8l242.9 185.8L362 168.6z"
      />
...
export default function CtaBand({
  ...
  return (
    <section id={id} className="relative overflow-hidden bg-[var(--brand)]">
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-4 py-20 md:py-24 text-center text-white">
        <motion.h2
