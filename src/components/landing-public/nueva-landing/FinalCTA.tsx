...
export default function FinalCTA({ mode = "paciente" }: Props) {
  ...
  const title = isPro ? t.finalCta.titlePro : t.finalCta.titlePaciente;

  const subtitle = isPro
    ? t.finalCta.subtitlePro
    : t.finalCta.subtitlePaciente;
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1200px] px-6 text-center">
        <ScrollReveal>
          <div className="mx-auto max-w-3xl">
            <span className="badge">{isPro ? t.finalCta.badgePro : t.finalCta.badgePaciente}</span>
